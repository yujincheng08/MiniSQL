...
template<class T>
vector<pos_type> bpTree<T>::Eqsearch(const T & key)
{
    vector<pos_type> pos;
...
template<class T>
vector<pos_type> bpTree<T>::Neqsearch(const T & key)
{
    vector<pos_type> pos;
...
template<class T>
vector<pos_type> bpTree<T>::Besearch(const T & key)
{
    int i;
    vector<pos_type> pos;
    findLeaf(key);
...
template<class T>
vector<pos_type> bpTree<T>::Bsearch(const T & key)
{
    int i;
    vector<pos_type> pos;
    findLeaf(key);
...
template<class T>
vector<pos_type> bpTree<T>::Ssearch(const T & key)
{
    vector<pos_type> pos;
    findLeaf(key);
    node *tmp = posNode;
...
template<class T>
vector<pos_type> bpTree<T>::Sesearch(const T & key)
{
    vector<pos_type> pos;
    findLeaf(key);
    node *tmp = posNode;
